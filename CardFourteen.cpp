...
bool CardFourteen::flag_P_F = false;
bool CardFourteen::flag_owner = false;
Player* CardFourteen::owner = NULL;
Player* CardFourteen::Passer = NULL;
...
void CardFourteen::ReadCardParameters(Grid* pGrid)
{
	...
	{
		pOut->PrintMessage("New Card 14: Enter its card price ...");
		bool z1, z2;
...
bool CardFourteen::SetPrice(int p)
{
	if (p > 0)
	{
		price = p;
...
bool CardFourteen::SetFees(int f)
{
	if (f > 0)
	{
		fees = f;
...
void CardFourteen::SetFlagpF(bool pf)
{
	flag_P_F = pf;
}
