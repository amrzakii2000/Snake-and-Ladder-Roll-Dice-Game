...
int  CardTen::price = 0;
int  CardTen::fees = 0;
bool CardTen::flag_P_F = false;
bool CardTen::flag_owner = false;
Player* CardTen::owner = NULL;
Player* CardTen::Passer = NULL;
...
void CardTen::ReadCardParameters(Grid* pGrid)
{
	...
	{
		pOut->PrintMessage("New Card 10: Enter its card price ...");
		bool z1, z2;
...
void CardTen::SetFlagpF(bool pf)
{
	flag_P_F = pf;
}
bool CardTen::SetFees(int f)
{
	if (f > 0)
	{
		fees = f;
