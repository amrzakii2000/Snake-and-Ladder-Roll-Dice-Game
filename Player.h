...
class Player
{
	...
	bool Forbidden;			// A boolean indicating wheheter the Player can roll dice or not
	bool Poisoned;			//A boolean indicating whether the Player is poisoned or not
	bool Fired;				//A boolean indicating whether the Player is Fired or not
...
public:
	...
	CellPosition GetCurrentCell() const;
