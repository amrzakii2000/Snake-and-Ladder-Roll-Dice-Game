...
bool Cardtwelve::flag_P_F = false;
bool Cardtwelve::flag_owner = false;
Player* Cardtwelve::owner = NULL;
Player* Cardtwelve::Passer = NULL;
...
void Cardtwelve::ReadCardParameters(Grid* pGrid)
{
	...
	{
		pOut->PrintMessage("New Card 12: Enter its card price ...");
		bool z1, z2;
...
void Cardtwelve::SetFlagpF(bool pf)
{
	flag_P_F = pf;
}
bool Cardtwelve::SetPrice(int p)
{
	if (p > 0)
	{
		price = p;
